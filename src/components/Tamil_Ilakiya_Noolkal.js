...
export class Tamil_Ilakiya_Noolkal extends Component {
    render() {
        return (
            <div>
                ...
                <div className="row">
                    <div className="col-12">
                        <ul className="breadcrumb">
                            ...
                            <li className="current"><a>தமிழ் இலக்கிய நூல்</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-lg-6 mb--30">
                            <article class="post sticky single-post format-image">
                                <header class="entry-header text-center">
                                    ...
                                    <h1 class="post-title">குறிஞ்சிச் சுவை     </h1>
                                    
                                </header>
                                <div class="post-thumbnail">
                                <Link  to='/book7'><img src="assets/img/books/KurunjiSuvai.jpg" width={240} height={278}/></Link>
                                </div>
                                <div class="post-info text-center">
                                    <div class="post-content">
                                        <p>எங்கணுமழகு, சுற்றிப் பார்க்குமிடனெல்லாம் சுவைதரும் எழிற் காட்சிகள். பலப்பல நிறங்களைக் காழ்ந்து மனிதனைத் தன் ...</p>
                                    </div>
                                   <Link  to='/book7' className="btn btn-read-more btn-style-3">View More</Link>
...
export default Tamil_Ilakiya_Noolkal