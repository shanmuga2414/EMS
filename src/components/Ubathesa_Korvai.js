...
export class Ubathesa_Korvai extends Component {
    render() {
        return (
            <div>
                ...
                <div className="row">
                    <div className="col-12">
                        <ul className="breadcrumb">
                            ...
                            <li className="current"><a>உபதேசக் கோர்வை</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-lg-6 mb--30">
                            <article class="post sticky single-post format-image">
                                <header class="entry-header text-center">
                                    ...
                                    <h1 class="post-title">மனிதா  </h1>
                                    
                                </header>
                                <div class="post-thumbnail">
                                <Link  to='/book6'><img src="assets/img/books/ManithaNew.jpg"/></Link>
                                </div>
                                <div class="post-info text-center">
                                    <div class="post-content">
                                        <p>ஆன்மீகத் தேடல் உள்ள ஒரு மனிதன் தன் குருவை எப்படி அடையாளம் கண்டுக் கொள்ளமுடியும்.?</p>
                                    </div>
                                   <Link  to='/book6' className="btn btn-read-more btn-style-3">View More</Link>
...
export default Ubathesa_Korvai