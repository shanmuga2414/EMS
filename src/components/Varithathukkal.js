...
export class Varithathukkal extends Component {
    render() {
        return (
            <div>
                ...
                <div className="row">
                    <div className="col-12">
                        <ul className="breadcrumb">
                            ...
                            <li className="current"><a>வாரிதாதத்துக்கள் (இறை ஞான வெளிப்பாடு)</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div className="col-lg-6 mb--30">
                            <article class="post sticky single-post format-image">
                                <header class="entry-header text-center">
                                    ...
                                    <h1 class="post-title">கஸீதத்துல் அஹ்மதிய்யா மற்றும் கஸீதத்துல் அவ்னிய்யா    </h1>
                                    
                                </header>
                                <div class="post-thumbnail">
                                <Link  to='/book18'><img src="assets/img/books/Holy_Quasidha.jpg" width={240} height={278}/></Link>
                                </div>
                                <div class="post-info text-center">
                                    <div class="post-content">
                                        <p>கஸீததுல் அஹ்மதிய்யா (மற்றும்) கஸீததுல் அவ்னிய்யா!...</p>
                                    </div>
                                   <Link  to='/book18' className="btn btn-read-more btn-style-3">View More</Link>
                        ...
                        <article class="post sticky single-post format-image">
                            <header class="entry-header text-center">
                                ...
                                <h1 class="post-title">இறையருட்பா      </h1>
                                
                            </header>
                            <div class="post-thumbnail">
                            <Link  to='/book17'><img src="assets/img/books/Irai_Arulpa.jpg" width={240} height={278}/></Link>
                            </div>
                            <div class="post-info text-center">
                                <div class="post-content">
                                    <p>பிரபஞ்சமே ஓருடல். அதிற் காண்பன அதன் அங்கங்கள்.கடவுளெனத் தனித் தொருவன் நின்றனன் ...</p>
                                </div>
                               <Link  to='/book17' className="btn btn-read-more btn-style-3">View More</Link>
