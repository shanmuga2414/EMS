...
export class Varalatru_Noolkal extends Component {
    render() {
        return (
            <div>
                ...
                <div className="row">
                    <div className="col-12">
                        <ul className="breadcrumb">
                            ...
                            <li className="current"><a>வரலாற்று நூற்கள்</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div className="container">
                    ...
                    <div class="row">
                        <div className="col-lg-6 mb--30">
                            <article class="post sticky single-post format-image">
                                <header class="entry-header text-center">
                                    ...
                                    <h1 class="post-title">அப்பாஸியாக்கள்    </h1>
                                    
                                </header>
                                <div class="post-thumbnail">
                                <Link  to='/book4'><img src="assets/img/books/abbasiyakkal.jpg" width={240} height={278}/></Link>
                                </div>
                                <div class="post-info text-center">
                                    <div class="post-content">
                                        <p>உமவிய்ய ஆட்சி முடிய அப்பாஸிகள் ஆட்சி ஆரம்பமாயிற்று. அது அறிவிற்கொரு ...</p>
                                    </div>
                                   <Link  to='/book4' className="btn btn-read-more btn-style-3">View More</Link>
                        ...
                        <article class="post sticky single-post format-image">
                            ...
                            <div class="post-thumbnail">
                            <Link  to='/book3'><img src="assets/img/books/Holy_Yaasin.jpg" width={240} height={278}/></Link>
                            </div>
                            <div class="post-info text-center">
                                <div class="post-content">
                                    <p>உமவிய்ய ஆட்சி முடிய அப்பாஸிகள் ஆட்சி ஆரம்பமாயிற்று. அது அறிவிற்கொரு ...</p>
                                </div>
                               <Link  to='/book3' className="btn btn-read-more btn-style-3">View More</Link>
...
export default Varalatru_Noolkal