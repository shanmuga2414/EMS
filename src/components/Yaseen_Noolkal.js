...
export class Yaseen_Noolkal extends Component {
    render() {
        return (
            <div>
                ...
                <div className="row">
                    <div className="col-12">
                        <ul className="breadcrumb">
                            <li><a href="#">Home</a></li>
                            <li className="current"><a>யாஸீன் மௌலானா(ரலி) நூற்கள்</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-lg-6 mb--30">
                            <article class="post sticky single-post format-image">
                                <header class="entry-header text-center">
                                    ...
                                    <h1 class="post-title">ஸஹீஹி லில் இமாமில் புகாரீ    </h1>
                                    
                                </header>
                                <div class="post-thumbnail">
                                <Link  to='/book1'><img src="assets/img/books/Holy_Buhari.jpg" width={240} height={278}/></Link>
                                </div>
                                <div class="post-info text-center">
                                    <div class="post-content">
                                        <p>கருணாகர காரூண்யனான அல்லாஹ்வின்  திருநாமத்தைக் கொண்டு இதைத் தொடங்குகிறேன்...</p>
                                    </div>
                                   <Link  to='/book1' className="btn btn-read-more btn-style-3">View More</Link>
